...
# Transforming the Date and Time from characters into objects
...
# make a plot with many graphs
par(mfrow=c(2,2))

# calling plot function that calls different plot functions to make the graph
with(subpower,{
